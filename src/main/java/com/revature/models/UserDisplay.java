...
public class UserDisplay {
	...
	public UserDisplay(int id, String username, String password, String firstName, String lastName, String email,
			String role) {
		super();
		this.id = id;
	...
	public String toString() {
		return "UserDisplay [id=" + id + ", username=" + username + ", password=" + password + ", firstName="
